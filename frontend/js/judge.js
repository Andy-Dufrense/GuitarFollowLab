...
import { matchChordIn, observedPitchClasses, midiToName, midiToHz, spectrumOf } from './engine/dsp.js?v=0924-2015';
import { LIVE_CHORDS } from './exercises.js';
import { CFG, CHORD_SETTLE_MS, FLUX_N } from './engine/config.js?v=0924-2015';
